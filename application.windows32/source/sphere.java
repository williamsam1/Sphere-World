...
float currY = 0;
float currZ = 0;
final float rotateSpeed = 0.025f*PI;
boolean keyW = false;
boolean keyS = false;
boolean keyA = false;
boolean keyD = false;
...
final float grav = 0;
final float maxVel = 0.25f;
final float restitution = 0.85f;
final float friction = .001f;
...
public class Sphere extends OctObject
{
 ...
 Sphere(MyVector3 pos0, MyVector3 vel0, MyVector3 a0, float rad, int c, float m)
 {
   pos = pos0;
   vel = vel0;
   a = a0;
...
public synchronized MyVector3 getVel()
{
 ...
 public boolean isColliding(Sphere ball)
 {
